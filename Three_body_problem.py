...
def update_point(body_0,body_1,body_2,velocity_0,time_step = 0.01,gravity = 1):
    distance_1 = ((body_0[0] - body_1[0]) ** 2 + \
                  (body_0[1] - body_1[1]) ** 2) ** (1/2)
    mag_acceleration_1 = gravity/(distance_1 ** 2)
    ...
    mag_acceleration_2 = gravity/(distance_2 ** 2)
...
def update_all(body_0,velocity_0,body_1,velocity_1,body_2,velocity_2):
    body_0_newpos = \
        update_point(body_0[-1], body_1[-1], body_2[-1], velocity_0[-1])[0]
    body_0_newvelocity = \
        update_point(body_0[-1], body_1[-1], body_2[-1], velocity_0[-1])[1]
        
    body_1_newpos = \
        update_point(body_1[-1], body_0[-1], body_2[-1], velocity_1[-1])[0]
    body_1_newvelocity = \
        update_point(body_1[-1], body_0[-1], body_2[-1], velocity_1[-1])[1]
    
    body_2_newpos = \
        update_point(body_2[-1], body_1[-1], body_0[-1], velocity_2[-1])[0]
    body_2_newvelocity = \
        update_point(body_2[-1], body_1[-1], body_0[-1], velocity_2[-1])[1]
...
def loop_it(body_0,velocity_0,body_1,velocity_1,body_2,velocity_2,ntimes = 50):
    n = 0
    while n <= ntimes:
        body_0,velocity_0,body_1,velocity_1,body_2,velocity_2 = \
            update_all(body_0,velocity_0,body_1,velocity_1,body_2,velocity_2)
        n += 1
...
def plot_it(body_0,velocity_0,body_1,velocity_1,body_2,velocity_2,ntimes = 50):
    body_0_x, body_0_y, body_1_x, body_1_y, body_2_x, body_2_y = \
        loop_it(body_0,velocity_0,body_1,velocity_1,body_2,velocity_2,ntimes)
